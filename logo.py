...
\033[1;33m    [ + ] \033[1;32mType Tool-X in your terminal.''')
  ...
  def update(self):
    self.tool_header()
    print ('''
\033[1;33m  [ 1 ] \033[1;32mUpdate your Tool.
\033[1;33m  [ 0 ] \033[1;32mFor Back.\033[00m''')
  ...
  def updated(self):
    self.tool_header()
    print ('''
\033[1;33m      [ + ] \033[1;32mTmux-tools Updated Successfully.
...
\033[1;31m  [ + ]  \033[1;31mPlease try again after some time.\033[00m''')
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
\033[1;33m       [+] Tool Name :- \033[1;32mtmux-tools
\033[1;33m       [+] Author :- \033[1;32mVatsal Kashyal
...
\033[1;33m [+] \033[1;32mMade for termux.
...
\033[01;33m|  00) Back                                   |
 \033[01;36m=============================================\033[00m""")
  ...
  def updating(self):
    print ("""\033[01;33m =============================================
\033[01;32m|______________ Updating tmux-tools ______________|
 \033[01;33m=============================================\033[00m""")
...
\033[1;33m  [ 3 ] \033[1;32mUpdate tmux-tools.
